...
-- Started on 2025-11-14 19:50:25
...
--
-- TOC entry 226 (class 1259 OID 32943)
...
--
-- TOC entry 225 (class 1259 OID 32942)
...
ALTER TABLE public.convenio_convenio_id_seq OWNER TO postgres;
...
--
-- TOC entry 221 (class 1259 OID 32924)
...
ALTER TABLE public.especialidade_especialidade_id_seq OWNER TO postgres;
...
--
-- TOC entry 224 (class 1259 OID 32934)
...
--
-- TOC entry 223 (class 1259 OID 32933)
...
ALTER TABLE public.exame_exame_id_seq OWNER TO postgres;
...
--
-- TOC entry 217 (class 1259 OID 32908)
...
--
-- TOC entry 220 (class 1259 OID 32916)
...
--
-- TOC entry 219 (class 1259 OID 32915)
...
ALTER TABLE public.medicamento_medicamento_id_seq OWNER TO postgres;
...
--
-- TOC entry 214 (class 1259 OID 32891)
...
--
-- TOC entry 213 (class 1259 OID 32890)
...
ALTER TABLE public.medico_medico_id_seq OWNER TO postgres;
...
--
-- TOC entry 212 (class 1259 OID 32884)
...
--
-- TOC entry 211 (class 1259 OID 32883)
...
ALTER TABLE public.paciente_paciente_id_seq OWNER TO postgres;
...
--
-- TOC entry 216 (class 1259 OID 32900)
...
ALTER TABLE public.responsavel_responsavel_id_seq OWNER TO postgres;
...
--
-- TOC entry 209 (class 1259 OID 32874)
...
--
-- TOC entry 3212 (class 2604 OID 32946)
...
--
-- TOC entry 3210 (class 2604 OID 32928)
...
--
-- TOC entry 3211 (class 2604 OID 32937)
...
--
-- TOC entry 3208 (class 2604 OID 32912)
...
--
-- TOC entry 3209 (class 2604 OID 32919)
...
--
-- TOC entry 3206 (class 2604 OID 32894)
...
--
-- TOC entry 3205 (class 2604 OID 32887)
...
--
-- TOC entry 3207 (class 2604 OID 32903)
...
--
-- TOC entry 3204 (class 2604 OID 32878)
...
--
-- TOC entry 3387 (class 0 OID 32943)
-- Dependencies: 226
...
--
-- TOC entry 3383 (class 0 OID 32925)
-- Dependencies: 222
...
--
-- TOC entry 3385 (class 0 OID 32934)
-- Dependencies: 224
-- Data for Name: exame; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.exame (exame_id, exame_nome, exame_tipo, exame_status, exame_orientacao, exame_horai, exame_horaf) FROM stdin;
\.


--
-- TOC entry 3379 (class 0 OID 32909)
-- Dependencies: 218
...
--
-- TOC entry 3381 (class 0 OID 32916)
-- Dependencies: 220
...
--
-- TOC entry 3375 (class 0 OID 32891)
-- Dependencies: 214
-- Data for Name: medico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.medico (medico_id, medico_nome, medico_crm, medico_cpf, medico_telefone, medico_email, medico_dtnascimento, medico_status, medico_sexo, medico_endereco) FROM stdin;
\.


--
-- TOC entry 3373 (class 0 OID 32884)
-- Dependencies: 212
-- Data for Name: paciente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.paciente (paciente_id, paciente_nome, paciente_telefone, paciente_cpf, paciente_dnas, paciente_email, paciente_endereco, paciente_status, paciente_alergia, paciente_sexo, paciente_nacionalidade, paciente_estadocivil) FROM stdin;
\.


--
-- TOC entry 3377 (class 0 OID 32900)
-- Dependencies: 216
...
--
-- TOC entry 3371 (class 0 OID 32875)
-- Dependencies: 210
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario (usuario_id, usuario_nome, usuario_cpf, usuario_email, usuario_senha, usuario_status) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.convenio_convenio_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.especialidade_especialidade_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.exame_exame_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.medicamento_medicamento_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.medico_medico_id_seq', 1, false);
...
--
-- TOC entry 3230 (class 2606 OID 32950)
...
--
-- TOC entry 3226 (class 2606 OID 32932)
...
--
-- TOC entry 3228 (class 2606 OID 32941)
...
--
-- TOC entry 3222 (class 2606 OID 32914)
...
--
-- TOC entry 3224 (class 2606 OID 32923)
...
--
-- TOC entry 3218 (class 2606 OID 32898)
...
--
-- TOC entry 3216 (class 2606 OID 32889)
...
--
-- TOC entry 3220 (class 2606 OID 32907)
...
--
-- TOC entry 3214 (class 2606 OID 32882)
...
-- Completed on 2025-11-14 19:50:27
